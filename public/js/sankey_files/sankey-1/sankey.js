d3.sankey = function() {
 ...
 sankey.sinksRight = function (_) {
  ...
  function computeNodeBreadths() {
    ...
    // JAVI: CÓDIGO AÑADIDO PARA REALIZAR CAMBIOS DE POSICIONAMIENTO DE LOS NODOS
/*
    // MATRIX INDEXES 
    IDX_ADGS = 0
    IDX_APDGM = 1
    ...
    IDX_M = 13
    IDX_D = 14
    IDX_NO_REGISTRO_ESTUDIOS_BASICOS = 15

    IDX_INDEF = 16
    IDX_TEMP = 17
    IDX_NO_REGISTRO_CONTRATO = 18
    ...
    remainingNodes[IDX_ADGS].x = 5;
    remainingNodes[IDX_APDGM].x = 3;
    remainingNodes[IDX_APDGS].x = 5;
    remainingNodes[IDX_BACH].x = 4;
    remainingNodes[IDX_ESO].x = 2;
    remainingNodes[IDX_EDGM].x = 3;
    remainingNodes[IDX_EDGS].x = 5;
    remainingNodes[IDX_ESD].x = 5;
    remainingNodes[IDX_FPB].x = 2;
    remainingNodes[IDX_FPGM].x = 3;
    remainingNodes[IDX_FPGS].x = 5;
    remainingNodes[IDX_PYSC].x = 6;
    remainingNodes[IDX_G].x = 6;
    remainingNodes[IDX_M].x = 7;
    remainingNodes[IDX_D].x = 8;
    remainingNodes[IDX_NO_REGISTRO_ESTUDIOS_BASICOS].x = 2;

    remainingNodes[IDX_INDEF].x = 12;
    remainingNodes[IDX_TEMP].x = 12;
    remainingNodes[IDX_NO_REGISTRO_CONTRATO].x = 12;

    remainingNodes[IDX_MUJER].x = 0;

    remainingNodes[IDX_AE1].x = 9;
    remainingNodes[IDX_AE2].x = 9;
    remainingNodes[IDX_AE3].x = 9;
    remainingNodes[IDX_AE4].x = 9;
    remainingNodes[IDX_AE5].x = 9;
    remainingNodes[IDX_AE6].x = 9;
    remainingNodes[IDX_AE7].x = 9;
    remainingNodes[IDX_AE8].x = 9;
    remainingNodes[IDX_AE9].x = 9;
    remainingNodes[IDX_AE10].x = 9;
    remainingNodes[IDX_AE11].x = 9;
    remainingNodes[IDX_AE12].x = 9;
    remainingNodes[IDX_AE13].x = 9;
    remainingNodes[IDX_AE14].x = 9;
    remainingNodes[IDX_AE15].x = 9;
    remainingNodes[IDX_AE16].x = 9;
    remainingNodes[IDX_AE17].x = 9;
    remainingNodes[IDX_AE18].x = 9;
    remainingNodes[IDX_AE19].x = 9;
    remainingNodes[IDX_AE20].x = 9;
    remainingNodes[IDX_AE21].x = 9;
    remainingNodes[IDX_AE22].x = 9;
    remainingNodes[IDX_AE23].x = 9;
*/
    ...
    while (remainingNodes.length && x < nodes.length) {
      nextNodes = [];
      remainingNodes.forEach(function(node) {
        // JAVI: CÓDIGO COMENTADO PARA REALIZAR CAMBIOS DE POSICIONAMIENTO DE LOS NODOS
//        node.x = x;
        node.dx = nodeWidth;
